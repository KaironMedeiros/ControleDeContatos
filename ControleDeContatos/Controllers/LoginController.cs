...
namespace ControleDeContatos.Controllers
{
    public class LoginController : Controller
    {
        ...
        public IActionResult LinkRedefinirSenha (RedefinirSenhaModel redefinirSenhaModel)
        {
                ...
                if (ModelState.IsValid)
                {
                    ...
                    if (usuario != null)
                    {
                        ...
                        if (emailEnviado)
                        {
                            ...
                            TempData["MensagemSucesso"] = $"Verifique a nova nova senha em seu e-mail"; 
                        }
                        else
                        {
            ...
            {
                TempData["MensagemErro"] = $"Ops, não foi possível redefinir sua senha, tente novamante, detalhe do erro: {erro.Message}";
                return RedirectToAction("Index");
            }
        }
    }
